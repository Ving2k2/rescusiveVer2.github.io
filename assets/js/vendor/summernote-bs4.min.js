...
!function (t, e) {
    ...
    return function (t) {
        ...
        0: function (e, n) {
            ...
            var h = /Edge\/\d+/.test(c), f = !!window.CodeMirror,
                p = "ontouchstart" in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
                m = u ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input", v = {
            ...
            var x = {
                head: y, last: k, initial: function (t) {
                    return t.slice(0, t.length - 1)
                }, tail: w, prev: function (t, e) {
                    if (t && t.length && e) {
                        var n = t.indexOf(e);
            ...
            function st(t, e) {
                ...
                var r = t.node.childNodes[t.offset], a = Y(t.node.cloneNode(!1), t.node);
            ...
            var mt = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "triggerEvent", value: function () {
                        var t = x.head(arguments), e = x.tail(x.from(arguments)),
                    ...
                    key: "invoke", value: function () {
                        var t = x.head(arguments), e = x.tail(x.from(arguments)), n = t.split("."), o = n.length > 1,
                            i = o && x.head(n), r = o ? x.last(n) : x.head(n), a = this.modules[i || "editor"];
            ...
            function gt(t, e) {
                ...
                for (n = 0; n < a.length; n++) if (!ft.isText(a[n])) {
            ...
            function bt(t) {
                var e = document.body.createTextRange(), n = function t(e, n) {
                    var o, i;
                    if (ft.isText(e)) {
                        var r = ft.listPrev(e, b.not(ft.isText)), a = x.last(r).previousSibling;
            ...
            i.a.fn.extend({
                summernote: function () {
                    var t = i.a.type(x.head(arguments)), e = "string" === t, n = "object" === t,
            ...
            var yt = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "normalize", value: function () {
                        var e = function (t, e) {
                            ...
                            var n = ft.ancestor(t.node, ft.isBlock), o = !1;
                            if (!o) {
                    ...
                    key: "expand", value: function (e) {
                        var n = ft.ancestor(this.sc, e), o = ft.ancestor(this.ec, e);
                    ...
                    key: "pasteHTML", value: function (t) {
                        t = i.a.trim(t);
                        var e = i()("<div></div>").html(t)[0], n = x.from(e.childNodes), o = this;
                    ...
                    key: "getWordsMatchRange", value: function (e) {
                        var n = this.getEndPoint(), o = ft.prevPointUntil(n, (function (o) {
                    ...
                    key: "paraBookmark", value: function (t) {
                        return {
                            s: {path: x.tail(ft.makeOffsetPath(x.head(t), this.sc)), offset: this.so},
                            e: {path: x.tail(ft.makeOffsetPath(x.last(t), this.ec)), offset: this.eo}
                        }
                    }
                }, {
                ...
                create: function (t, e, n, o) {
                    ...
                    var e = t, n = 0, o = t, i = ft.nodeLength(o);
                    ...
                    var n = ft.fromOffsetPath(t, e.s.path), o = e.s.offset, i = ft.fromOffsetPath(t, e.e.path),
                        r = e.e.offset;
                    return new yt(n, o, i, r)
                }, createFromParaBookmark: function (t, e) {
                    var n = t.s.offset, o = t.e.offset, i = ft.fromOffsetPath(x.head(e), t.s.path),
                ...
                }, nameFromCode: b.invertObject(wt), code: wt
            };
            ...
            var Et = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "styleNodes", value: function (t, e) {
                        ...
                        if (o) {
                            ...
                            return s.map((function (t) {
                                var e = ft.withClosestSiblings(t, a), n = x.head(e), o = x.tail(e);
                    ...
                    key: "current", value: function (t) {
                        var e = i()(ft.isElement(t.sc) ? t.sc : t.sc.parentNode), n = this.fromNode(e);
                        try {
                            n = i.a.extend(n, {
            ...
            var $t = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "indent", value: function (t) {
                        var e = this, n = kt.create(t).wrapBodyInlineWithPara(),
                            o = n.nodes(ft.isPara, {includeAncestor: !0}), r = x.clusterBy(o, b.peq2("parentNode"));
                    ...
                    key: "toggleList", value: function (t, e) {
                        var n = this, o = kt.create(e).wrapBodyInlineWithPara(),
                            r = o.nodes(ft.isPara, {includeAncestor: !0}), a = o.paraBookmark(r),
                    ...
                    key: "wrapList", value: function (t, e) {
                        var n = x.head(t), o = x.last(t), i = ft.isList(n.previousSibling) && n.previousSibling,
                    ...
                    key: "releaseList", value: function (t, e) {
                        ...
                        return i.a.each(t, (function (t, r) {
                            var a = x.head(r), s = x.last(r), l = e ? ft.lastAncestor(a, ft.isList) : a.parentNode,
                                c = l.parentNode;
                            if ("LI" === l.parentNode.nodeName) r.map((function (t) {
                                ...
                                }, {isSkipPaddingBlankHTML: !0}) : null, d = ft.splitTree(l, {
                                    node: a.parentNode,
            ...
            Lt.where = {Row: 0, Column: 1}, Lt.requestAction = {Add: 0, Delete: 1}, Lt.resultAction = {
                Ignore: 0,
                SubtractSpanCount: 1,
                RemoveCell: 2,
                AddCell: 3,
            ...
            var At = function () {
                ...
                return e = t, (n = [{
                    key: "tab", value: function (t, e) {
                        var n = ft.ancestor(t.commonAncestor(), ft.isCell), o = ft.ancestor(n, ft.isTable),
                            i = ft.listDescendant(o, ft.isCell), r = x[e ? "prev" : "next"](i, n);
                    ...
                    key: "addCol", value: function (t, e) {
                        var n = ft.ancestor(t.commonAncestor(), ft.isCell), o = i()(n).closest("tr");
                        i()(o).siblings().push(o);
                    ...
                    key: "deleteRow", value: function (t) {
                        for (var e = ft.ancestor(t.commonAncestor(), ft.isCell), n = i()(e).closest("tr"), o = n.children("td, th").index(i()(e)), r = n[0].rowIndex, a = new Lt(e, Lt.where.Row, Lt.requestAction.Delete, i()(n).closest("table")[0]).getActionList(), s = 0; s < a.length; s++) if (a[s]) {
                    ...
                    key: "deleteCol", value: function (t) {
                        for (var e = ft.ancestor(t.commonAncestor(), ft.isCell), n = i()(e).closest("tr"), o = n.children("td, th").index(i()(e)), r = new Lt(e, Lt.where.Column, Lt.requestAction.Delete, i()(n).closest("table")[0]).getActionList(), a = 0; a < r.length; a++) if (r[a]) switch (r[a].action) {
                            case Lt.resultAction.Ignore:
                                continue;
                            case Lt.resultAction.SubtractSpanCount:
                                var s = r[a].baseCell;
            ...
            var Dt = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "handleKeyMap", value: function (t) {
                        var e = this.options.keyMap[v.isMac ? "mac" : "pc"], n = [];
                        ...
                        } else Ct.isEdit(t.keyCode) && this.afterCommand(); else this.afterCommand();
                        return !1
                    }
                }, {
                    ...
                    key: "getLinkInfo", value: function () {
                        var t = this.getLastRange().expand(ft.isAnchor), e = i()(x.head(t.nodes(ft.isAnchor))),
            ...
            var Gt = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "update", value: function (t, e) {
                        ...
                        var n = ft.isImg(t), o = this.$handle.find(".note-control-selection");
                    ...
                    key: "update", value: function () {
                        if (this.context.invoke("editor.hasFocus")) {
                            ...
                            if (t.isCollapsed() && t.isOnAnchor()) {
                                var e = ft.ancestor(t.sc, ft.isAnchor), n = i()(e).attr("href");
                                this.$popover.find("a").attr("href", n).text(n);
                                var o = ft.posFromPlaceholder(e), r = i()(this.options.container).offset();
            ...
            var ge = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "update", value: function (t) {
                        ...
                        var e = ft.isCell(t);
                        if (e) {
                            var n = ft.posFromPlaceholder(t), o = i()(this.options.container).offset();
            ...
            var we = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "createShortcutList", value: function () {
                        var t = this, e = this.options.keyMap[v.isMac ? "mac" : "pc"];
                        return Object.keys(e).map((function (n) {
                            var o = e[n], r = i()('<div><div class="help-list-item"/></div>');
            ...
            var Te = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "createGroup", value: function (t, e) {
                        var n = this, o = i()('<div class="note-hint-group note-hint-group-' + t + '"/>');
            ...
            i.a.summernote = i.a.extend(i.a.summernote, {
                version: "0.8.16", plugins: {}, dom: ft, range: kt, lists: x, options: {
